...
func (m *VTProtoBufA) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *VTProtoBufA) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VTProtoBufA) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
var vtprotoPool_VTProtoBufA = sync.Pool{
	New: func() interface{} {
		return &VTProtoBufA{}
	},
}

func (m *VTProtoBufA) ResetVT() {
	m.Reset()
}
func (m *VTProtoBufA) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_VTProtoBufA.Put(m)
	}
}
func VTProtoBufAFromVTPool() *VTProtoBufA {
	return vtprotoPool_VTProtoBufA.Get().(*VTProtoBufA)
}
func (m *VTProtoBufA) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VTProtoBufA) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: VTProtoBufA: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VTProtoBufA: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
